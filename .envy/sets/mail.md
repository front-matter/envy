---
description: Mail defines email configuration.
hideTitle: true
title: mail
toc: false
weight: 6
...
{{< cards cols="1" >}}
{{< card title="mail" cardType="set" description=`Mail defines email configuration.` descriptionLink="https://inveniordm.docs.cern.ch/operate/customize/emails/" tagsServices="web,worker" >}}
{{< /cards >}}
...
{{< cards cols="1" >}}
{{< card link="" title="INVENIO_MAIL_PASSWORD" cardType="var" tagBottom="secret" tagBottomColor="orange" >}}
{{< /cards >}}
