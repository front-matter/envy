---
description: Base defines shared environment variables for web and worker.
hideTitle: true
title: base
toc: false
weight: 2
...
{{< cards cols="1" >}}
{{< card title="base" cardType="set" description=`Base defines shared environment variables for web and worker.` descriptionLink="https://inveniordm.docs.cern.ch/operate/customize/i18n-and-l10n/" tagsServices="web,worker" >}}
{{< /cards >}}
