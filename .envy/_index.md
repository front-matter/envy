...
`envy build` writes generated Markdown into the local [.envy](.envy) folder.

- Generated pages are written under [.envy/sets](.envy/sets), [.envy/services](.envy/services), and [.envy/profiles](.envy/profiles)
- Generated home pages are written to [.envy/_index.md](.envy/_index.md) and localized variants
